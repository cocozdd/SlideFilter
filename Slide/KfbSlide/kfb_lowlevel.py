...
if sys.platform=='win32':
    ...
    _lib = windll.LoadLibrary(os.path.join(os.path.abspath(os.path.dirname(__file__)),'win_libs',"libkfbslide.dll"))
else:
    _lib = cdll.LoadLibrary(os.path.join(os.path.dirname(os.path.abspath(__file__)),'linux_libs','libkfbslide.so'))
